...
import com.clothstore.service.TokenBlacklistService;
...
public class JwtAuthFilter extends OncePerRequestFilter {
    ...
    protected void doFilterInternal(
        ...
        try {
            // Reject blacklisted (logged-out) access tokens immediately
            ...
            // Invalid token — leave SecurityContext empty; endpoint will return 401 if protected
        }
